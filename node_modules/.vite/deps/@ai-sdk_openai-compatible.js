import { A as generateId, At as string, Dt as number, Gt as TooManyEmbeddingValuesForCallError, J as parseProviderOptions, L as isCustomReasoning, Lt as InvalidPromptError, Ot as object, P as getTopLevelMediaType, T as downloadBlob, Tt as looseObject, X as postFormDataToApi, Z as postJsonToApi, at as serializeModelOptions, b as createLanguageModelResponseMetadata, bt as boolean, dt as withoutTrailingSlash, et as resolveFullMediaType, f as convertBase64ToUint8Array, g as createEventSourceResponseHandler, ht as _enum, i as StreamingToolCallTracker, jt as union, kt as record, m as convertToFormData, mt as WORKFLOW_SERIALIZE, p as convertToBase64, pt as WORKFLOW_DESERIALIZE, qt as UnsupportedFunctionalityError, u as combineHeaders, ut as withUserAgentSuffix, v as createJsonErrorResponseHandler, vt as any, wt as literal, x as createNullLanguageModelUsage, y as createJsonResponseHandler, yt as array } from "./dist-C-6W2Odr.js";
...
var OpenAICompatibleChatLanguageModel = class _OpenAICompatibleChatLanguageModel {
	...
	async getArgs({ prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, reasoning, providerOptions, stopSequences, responseFormat, seed, toolChoice, tools }) {
		...
		return {
			...
			args: {
				...
				messages: convertToOpenAICompatibleChatMessages(prompt, { providerOptionsKey: metadataKey }),
				tools: openaiTools,
	...
	async doGenerate(options) {
		...
		const providerMetadata = {
			[metadataKey]: {},
			...await ((_g = (_f = this.config.metadataExtractor) == null ? void 0 : _f.extractMetadata) == null ? void 0 : _g.call(_f, { parsedBody: rawResponse }))
		};
