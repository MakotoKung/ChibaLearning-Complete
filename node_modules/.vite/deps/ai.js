...
import { $ as resolve, A as generateId, At as string, B as isNonNullable, Bt as LoadAPIKeyError, C as delay, Ct as lazy, D as executeTool, Dt as number, E as dynamicTool, Et as never, F as isAbortError, Ft as EmptyResponseBodyError, G as loadOptionalSetting, Gt as TooManyEmbeddingValuesForCallError, H as isUrlSupported, Ht as NoContentGeneratedError, I as isBuffer, It as InvalidArgumentError$1, Jt as getErrorMessage, K as normalizeHeaders, Kt as TypeValidationError, Lt as InvalidPromptError, M as getRuntimeEnvironmentUserAgent, Mt as unknown, N as getToolCaller, Nt as AISDKError, O as fetchWithValidatedRedirects, Ot as object, Pt as APICallError, Q as readResponseWithSizeLimit, R as isExecutableTool, Rt as InvalidResponseDataError, S as createProviderExecutedToolFactory, St as discriminatedUnion, Tt as looseObject, U as jsonSchema, Ut as NoSuchModelError, V as isProviderReference, Vt as LoadSettingError, W as lazySchema, Wt as NoSuchProviderReferenceError, Xt as isJSONObject, Y as parseTranscriptionStreamPart, Yt as isJSONArray, Z as postJsonToApi, _ as createIdGenerator, _t as _null, a as TRANSCRIPTION_STREAM_AUDIO_DONE_FRAME_TYPE, at as serializeModelOptions, bt as boolean, c as asSchema, ct as validateTypes, d as connectToWebSocket, dt as withoutTrailingSlash, f as convertBase64ToUint8Array, ft as zodSchema, g as createEventSourceResponseHandler, gt as _instanceof, h as convertUint8ArrayToBase64, ht as _enum, it as secureJsonParse, j as getFromApi, jt as union, k as filterNullable, kt as record, l as cancelResponseBody, lt as waitForWebSocketBufferDrain, mt as WORKFLOW_SERIALIZE, n as DelayedPromise, nt as safeParseJSON, o as TRANSCRIPTION_STREAM_START_FRAME_TYPE, ot as tool, pt as WORKFLOW_DESERIALIZE, q as parseJsonEventStream, qt as UnsupportedFunctionalityError, r as DownloadError, rt as safeValidateTypes, s as asArray, st as toolCaller, t as DEFAULT_MAX_DOWNLOAD_SIZE, tt as retryWithExponentialBackoff, u as combineHeaders, ut as withUserAgentSuffix, v as createJsonErrorResponseHandler, vt as any, w as detectMediaType, wt as literal, xt as custom, y as createJsonResponseHandler, yt as array, z as isFullMediaType, zt as JSONParseError } from "./dist-C-6W2Odr.js";
...
var name9$1 = "GatewayTimeoutError";
var marker10$1 = `vercel.ai.gateway.error.${name9$1}`;
var symbol10$1 = Symbol.for(marker10$1);
var _a10$1;
var _b10;
var GatewayTimeoutError = class _GatewayTimeoutError extends (_b10 = GatewayError, _a10$1 = symbol10$1, _b10) {
...
var exaSearchInputSchema = lazySchema(() => zodSchema(z$1.object({
...
var exaSearchOutputSchema = lazySchema(() => zodSchema(z$1.union([z$1.object({
...
var parallelSearchInputSchema = lazySchema(() => zodSchema(z$1.object({
...
var parallelSearchOutputSchema = lazySchema(() => zodSchema(z$1.union([z$1.object({
	searchId: z$1.string(),
	results: z$1.array(z$1.object({
		url: z$1.string(),
		title: z$1.string(),
...
var perplexitySearchInputSchema = lazySchema(() => zodSchema(z$1.object({
...
var perplexitySearchOutputSchema = lazySchema(() => zodSchema(z$1.union([z$1.object({
	results: z$1.array(z$1.object({
		title: z$1.string(),
		url: z$1.string(),
		snippet: z$1.string(),
...
async function getVercelRequestId() {
	var _a11;
	return (_a11 = (0, import_index_browser.getContext)().headers) == null ? void 0 : _a11["x-vercel-id"];
}
var VERSION$1 = "4.0.56";
...
var _a13;
var NoTranslationGeneratedError = class extends AISDKError {
	constructor(options) {
		super({
			name: name13,
...
function resolveTranscriptionModel(model) {
	var _a23, _b;
	if (typeof model === "string") return (_b = (_a23 = getGlobalProvider()).transcriptionModel) == null ? void 0 : _b.call(_a23, model);
	if (![
		"v4",
		"v3",
		"v2"
...
function resolveSpeechTranslationModel(model) {
	...
	if (typeof model === "string") {
		const speechTranslationModel = ((_a23 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a23 : gateway).speechTranslationModel;
...
function resolveSpeechModel(model) {
	var _a23, _b;
	if (typeof model === "string") return (_b = (_a23 = getGlobalProvider()).speechModel) == null ? void 0 : _b.call(_a23, model);
	if (![
		"v4",
		"v3",
		"v2"
...
function resolveVideoModel(model) {
	var _a23;
	if (typeof model === "string") {
		const videoModel = ((_a23 = globalThis.AI_SDK_DEFAULT_PROVIDER) != null ? _a23 : gateway).videoModel;
...
function hasToolCall(...toolName) {
	return ({ steps }) => {
		var _a23, _b, _c;
		return (_c = (_b = (_a23 = steps[steps.length - 1]) == null ? void 0 : _a23.toolCalls) == null ? void 0 : _b.some((toolCall) => toolName.includes(toolCall.toolName))) != null ? _c : false;
	};
}
...
function createUIMessageStream({ execute, onError = () => "An error occurred.", originalMessages, onStepEnd, onStepFinish, onEnd, onFinish, generateId: generateId3 = generateId }) {
	let controller;
	...
	try {
		...
		if (dataSchemas || tools) for (const [msgIdx, message] of validatedMessages.entries()) for (const [partIdx, part] of message.parts.entries()) {
			...
			if (tools && part.type.startsWith("tool-")) {
				...
				if (toolPart.state === "input-available") await validateTypes({
					value: toolPart.input,
...
async function startTextBatch({ model: modelArg, requests, providerOptions, abortSignal, headers, timeout }) {
	...
	const headersWithUserAgent = withUserAgentSuffix(headers != null ? headers : {}, `ai/${VERSION}`);
	try {
		const { batchId, warnings, ...status } = await model.experimental_doStartBatch({
...
async function getBatchStatus({ model: modelArg, batch, providerOptions, maxRetries, abortSignal, headers, timeout }) {
	...
	try {
		return await retry(() => model.experimental_doGetBatchStatus({
			batchId: batch.id,
			providerOptions,
			abortSignal: operationAbortSignal,
			headers: withUserAgentSuffix(headers != null ? headers : {}, `ai/${VERSION}`)
		}));
	} catch (error) {
		throw wrapGatewayError(error);
	}
...
function getBatchResults({ model: modelArg, batch, providerOptions, maxRetries, abortSignal, headers, timeout }) {
	...
	const transform = new TransformStream({
		...
		cancel(reason) {
			streamAbortController.abort(reason != null ? reason : /* @__PURE__ */ new Error("Batch results stream was cancelled."));
		}
	});
	(async () => {
		try {
			await (await retry(() => model.experimental_doGetBatchResults({
				batchId: batch.id,
				providerOptions,
				abortSignal: operationAbortSignal,
				headers: withUserAgentSuffix(headers != null ? headers : {}, `ai/${VERSION}`)
...
function resolveBatchLanguageModel(modelArg) {
	const model = resolveLanguageModel(modelArg);
	if (!isBatchLanguageModel(model)) throw new UnsupportedFunctionalityError({
...
function validateBatchReference({ model, batch }) {
	if (batch.version !== 1 || batch.type !== "text") throw new InvalidArgumentError({
		parameter: "batch",
		value: batch,
		message: "batch must be a supported text batch reference"
	});
	if (batch.provider !== model.provider || batch.modelId !== model.modelId) throw new InvalidArgumentError({
		parameter: "model",
		value: model,
	...
	for (const result of results) {
		images.push(...result.images.map((image) => {
			...
			return new DefaultGeneratedFile({
				data: image,
				mediaType: (_a24 = detectMediaType({
					data: image,
					topLevelType: "image"
				})) != null ? _a24 : "image/png"
			});
...
function simulateReadableStream({ chunks, initialDelayInMs = 0, chunkDelayInMs = 0, _internal }) {
	var _a23;
	const delay$1 = (_a23 = _internal == null ? void 0 : _internal.delay) != null ? _a23 : delay;
	let index = 0;
...
function streamObject(options) {
	const { model, output = "object", instructions, system, prompt, messages, allowSystemInMessages, maxRetries, abortSignal, headers, experimental_repairText, repairText = experimental_repairText, experimental_telemetry, telemetry = experimental_telemetry, experimental_download: download2, providerOptions, onStart, experimental_onStart, onStepStart, experimental_onStepStart, onStepEnd, onStepFinish, onError = ({ error }) => {
		console.error(error);
	}, onFinish, _internal: { generateId: generateId3 = originalGenerateId5, currentDate = () => /* @__PURE__ */ new Date(), now: now2 = now } = {}, ...settings } = options;
...
async function fingerprintTools(tools) {
	const entries = await Promise.all(Object.keys(tools).map(async (name23) => {
		const tool2 = tools[name23];
		return [name23, await hashCanonical({
...
function detectToolDrift(current, baseline) {
	...
	const removed = [];
	const changed = [];
	for (const name23 of Object.keys(current)) if (!Object.hasOwn(baseline, name23)) added.push(name23);
	else if (current[name23] !== baseline[name23]) changed.push(name23);
	for (const name23 of Object.keys(baseline)) if (!Object.hasOwn(current, name23)) removed.push(name23);
	return {
		added,
		removed,
		changed
...
async function experimental_generateVideo({ model: modelArg, prompt: promptArg, n = 1, maxVideosPerCall, aspectRatio, resolution, duration, fps, seed, frameImages, inputReferences, generateAudio, providerOptions, maxRetries: maxRetriesArg, abortSignal, headers, download: downloadFn = defaultDownload, poll, webhook }) {
	...
	const firstFrameImage = (_a23 = normalizedFrameImages == null ? void 0 : normalizedFrameImages.find((frame) => frame.frameType === "first_frame")) == null ? void 0 : _a23.image;
...
async function executeStartStatusFlow({ model, callOptions, poll: pollConfig, webhook: webhookFactory, retry }) {
	...
	const callerIdempotencyKey = Object.entries((_a23 = callOptions.headers) != null ? _a23 : {}).find(([key, value]) => key.toLowerCase() === "idempotency-key" && value !== void 0);
	...
	const delay$3 = (_d = pollConfig == null ? void 0 : pollConfig.delay) != null ? _d : delay;
	...
	while (true) {
		if (webhookReceived == null) {
			...
			if (elapsedMs >= timeoutMs) throw new Error(`Video generation timed out after ${timeoutMs}ms.`);
			await delay$3(Math.min(intervalMs, timeoutMs - elapsedMs), { abortSignal: callOptions.abortSignal });
			if (Date.now() - startTime >= timeoutMs) throw new Error(`Video generation timed out after ${timeoutMs}ms.`);
		}
...
function addToolInputExamplesMiddleware({ prefix = "Input Examples:", format = defaultFormatExample, remove = true } = {}) {
	return {
		...
		transformParams: async ({ params }) => {
			var _a23;
			if (!((_a23 = params.tools) == null ? void 0 : _a23.length)) return params;
			const transformedTools = params.tools.map((tool2) => {
				var _a24;
				if (tool2.type !== "function" || !((_a24 = tool2.inputExamples) == null ? void 0 : _a24.length)) return tool2;
		...
		switch (toolType) {
			...
			case "dynamic": {
				...
				definitions.push({
					...
					name: name23,
					description,
					parameters: await asSchema(tool2.inputSchema).jsonSchema
				});
				break;
			}
			case "provider": break;
...
function resolveRealtimeToolDescription({ tool: tool2, toolName, toolsContext }) {
	return tool2.description === void 0 ? void 0 : typeof tool2.description === "string" ? tool2.description : tool2.description({ context: toolsContext[toolName] });
}
var BrowserRealtimeAudio = class {
	...
	ensurePlaybackContext() {
		if (this.playbackContext == null) this.playbackContext = new AudioContext({ sampleRate: this.playbackSampleRate });
	}
	startCapture(stream) {
	...
	stopCapture() {
		var _a23, _b, _c, _d;
		(_a23 = this.captureProcessor) == null || _a23.disconnect();
		(_b = this.captureSource) == null || _b.disconnect();
		(_c = this.captureContext) == null || _c.close();
		(_d = this.captureStream) == null || _d.getTracks().forEach((track) => track.stop());
		this.captureProcessor = null;
		this.captureSource = null;
		this.captureContext = null;
		this.captureStream = null;
	...
	dispose() {
		...
		this.stopCapture();
		this.stopPlayback();
		(_a23 = this.playbackContext) == null || _a23.close();
		this.playbackContext = null;
	}
	setPlaying(isPlaying) {
		var _a23, _b;
		if (isPlaying && !this.isPlaying) this.playbackStartTime = (_b = (_a23 = this.playbackContext) == null ? void 0 : _a23.currentTime) != null ? _b : 0;
...
var BrowserRealtimeTransport = class {
	...
	connect({ token, url, onOpen }) {
		...
		ws.onerror = () => {
			this.onError(/* @__PURE__ */ new Error("WebSocket connection error"));
		};
		ws.onclose = () => {
			if (this.ws === ws) {
				this.ws = null;
	...
	sendEvent(event) {
		this.sendQueue = this.sendQueue.then(async () => {
			...
			if (serialized != null) this.sendRaw(serialized);
		}).catch((error) => {
			this.onError(error instanceof Error ? error : /* @__PURE__ */ new Error(`Failed to send realtime event: ${String(error)}`));
		});
	}
	sendRaw(data) {
		var _a23;
		if (((_a23 = this.ws) == null ? void 0 : _a23.readyState) === WebSocket.OPEN) {
			if (typeof data === "string" || data instanceof ArrayBuffer || ArrayBuffer.isView(data) || data instanceof Blob) this.ws.send(data);
	...
	async handleMessage(messageEvent) {
		let text2;
		if (typeof messageEvent.data === "string") text2 = messageEvent.data;
		else if (messageEvent.data instanceof Blob) text2 = await messageEvent.data.text();
		else text2 = new TextDecoder().decode(messageEvent.data);
		const parseResult = await safeParseJSON({ text: text2 });
		...
		if (this.model.getHealthCheckResponse != null) {
			...
			if (autoResponse != null) this.sendRaw(autoResponse);
		}
		const result = this.model.parseServerEvent(rawEvent);
		const events = Array.isArray(result) ? result : [result];
		for (const event of events) await this.onServerEvent(event);
	}
};
...
var RealtimeEventReducer = class {
	...
	addInputTranscriptionMessage(state, itemId, transcript) {
		...
		const insertIndex = Math.min((_a23 = this.inputAudioMessageInsertIndex.get(itemId)) != null ? _a23 : state.messages.length, state.messages.length);
	...
	appendTextDelta(state, itemId, delta) {
		...
		const text2 = ((_a23 = this.textAccumulators.get(itemId)) != null ? _a23 : "") + delta;
...
var AbstractRealtimeSession = class {
	constructor(options) {
		...
		this.transport = new BrowserRealtimeTransport({
			...
			onError: (error) => {
				...
				(_a24 = this.onError) == null || _a24.call(this, error);
			},
			onClose: () => {
	...
	async connect() {
		...
		try {
			...
			this.applyState(this.reducer.setStatus(this.state, "error"));
			(_a23 = this.onError) == null || _a23.call(this, error instanceof Error ? error : /* @__PURE__ */ new Error(`Connection failed: ${String(error)}`));
		}
	}
	disconnect() {
	...
	*/
	maybeRequestToolResponse() {
		...
		for (const callId of this.toolCallsInResponse) if (!this.submittedToolOutputs.has(callId)) return;
		this.sendEvent({ type: "response-create" });
	...
	applyState(nextState) {
		...
		if (previousState.status !== nextState.status) this.setState("status", nextState.status);
		if (previousState.messages !== nextState.messages) this.setState("messages", nextState.messages);
		if (previousState.events !== nextState.events) this.setState("events", nextState.events);
		if (previousState.isCapturing !== nextState.isCapturing) this.setState("isCapturing", nextState.isCapturing);
		if (previousState.isPlaying !== nextState.isPlaying) this.setState("isPlaying", nextState.isPlaying);
	}
	async executeToolCall({ name: name23, args, callId }) {
		var _a23, _b;
		if (this.onToolCall == null) {
			(_a23 = this.onError) == null || _a23.call(this, /* @__PURE__ */ new Error(`No handler provided for tool "${name23}"`));
			return;
		}
		try {
			...
			if (result !== void 0) this.addToolOutput(callId, result);
		} catch (error) {
			(_b = this.onError) == null || _b.call(this, error instanceof Error ? error : /* @__PURE__ */ new Error(`Client tool execution failed: ${String(error)}`));
		}
	}
	async handleServerEvent(event) {
		...
		(_a23 = this.onEvent) == null || _a23.call(this, event);
		...
		switch (effect.type) {
			...
			case "speech-started":
				if (this.state.isPlaying) {
					...
					this.audio.stopPlayback();
					if (this.currentResponseItemId != null) this.sendEvent({
			...
			case "tool-call":
				...
				break;
			case "error": (_a23 = this.onError) == null || _a23.call(this, effect.error);
		}
	}
};
function customProvider({ languageModels, embeddingModels, imageModels, transcriptionModels, speechModels, rerankingModels, videoModels, files, skills, fallbackProvider: fallbackProviderArg }) {
	...
	const filesAndSkills = {
		...files != null || (fallbackProvider == null ? void 0 : fallbackProvider.files) != null ? { files() {
			return files != null ? files : fallbackProvider.files();
		} } : {},
		...skills != null || (fallbackProvider == null ? void 0 : fallbackProvider.skills) != null ? { skills() {
...
var DefaultProviderRegistry = class {
	...
	languageModel(id) {
		...
		let model = (_b = (_a23 = this.getProvider(providerId, "languageModel")).languageModel) == null ? void 0 : _b.call(_a23, modelId);
...
function streamTranscribe({ model, audio, inputAudioFormat, providerOptions = {}, abortSignal, headers, includeRawChunks, _internal: { currentDate = () => /* @__PURE__ */ new Date() } = {} }) {
	...
	const transform = new TransformStream({
		...
		cancel(reason) {
			pipeAbortController.abort(reason != null ? reason : /* @__PURE__ */ new Error("Transcription stream was cancelled."));
		}
	});
	(async () => {
		var _a24, _b, _c, _d, _e;
		...
		const reason = error != null ? error : /* @__PURE__ */ new Error("Transcription stream was cancelled or errored.");
...
function streamTranslate({ model, audio, inputAudioFormat, targetLanguage, sourceLanguage, outputAudioFormat, providerOptions = {}, abortSignal, headers, includeRawChunks, _internal: { currentDate = () => /* @__PURE__ */ new Date() } = {} }) {
	...
	const transform = new TransformStream({
		...
		cancel(reason) {
			pipeAbortController.abort(reason != null ? reason : /* @__PURE__ */ new Error("Translation stream was cancelled."));
		}
	});
	(async () => {
		...
		const reason = error != null ? error : /* @__PURE__ */ new Error("Translation stream was cancelled or errored.");
		rejectPendingPromises(reason);
		audio.cancel(reason).catch(() => {});
		transform.writable.abort(reason).catch(() => {});
	});
...
async function callCompletionApi({ api, prompt, credentials, headers, body, streamProtocol = "data", setCompletion, setLoading, setError, setAbortController, onFinish, onError, fetch: fetch2 = getOriginalFetch() }) {
	...
	try {
		...
		if (!response.ok) throw new Error((_a23 = await response.text()) != null ? _a23 : "Failed to fetch the chat response.");
...
async function uploadFile({ api, data: dataArg, mediaType: mediaTypeArg, filename, providerOptions }) {
	...
	const mediaType = mediaTypeArg != null ? mediaTypeArg : data.type === "text" ? "text/plain" : (_a23 = detectMediaType({ data: data.data })) != null ? _a23 : isLikelyText(data.data) ? "text/plain" : "application/octet-stream";
	const result = await ("uploadFile" in api ? api : typeof api.files === "function" ? api.files() : (() => {
